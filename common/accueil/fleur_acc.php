  <!-- SELECTION DE FLEURS PAGE ACCUEIL -->

  <h1 class="selection">NOTRE SELECTION</h1>
  <h1 class=" fleurs selection">FLEURS / BOUQUETS</h1>
  ...
  <a class="lien_fleur" href="index.php?uc=visite&action=voirFleur&type=Fleurs">
      <div class="btn_voir_fleur">PLUS</div>
  </a>